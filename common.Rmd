...
```
Từ dữ liệu ta thấy rằng, ung thư loại Prostate là loại ung thư chỉ xảy ra ở Male nên giá trị này ở Female tất nhiên phải bằng 0 nên giá trị zero ở đây là structual zero. Còn đối với ung thư loại Breast thì có thể xảy ra cả ở Male và Female tuy nhiên sẽ ít hơn rất nhiều ở Male nên giá trị 0 này sẽ là sampling zero.
